...
平遙話有26塊聲母，36塊韻母。（平遙轄區內語音有差異，這兒以城闔裏的發音爲準。）
簡單介紹如下：
...
注意其中陰入標記和平聲一樣，多是`̄ `；陽入標記和上聲一樣，多是`̀ `；不過入聲音節多以`-q`結尾，所以不混淆。不方便輸入帶調字母的時候，可以在音節後背加數字代替：平聲`1`、上聲`2`、去聲`3`、陰入`4`、陽入`5`。
...
<ruby>今<rp>（</rp><rt>jiēng</rt><rp>）</rp>日<rp>（</rp><rt>ràq</rt><rp>）</rp></ruby> 
...
<ruby>下<rp>（</rp><rt>há</rt><rp>）</rp>將<rp>（</rp><rt>jyuō</rt><rp>）</rp>雪<rp>（</rp><rt>xyuāq</rt><rp>）</rp>來<rp>（</rp><rt>lāe</rt><rp>）</rp>啦<rp>（</rp><rt>la</rt><rp>）</rp></ruby>

<ruby>你<rp>（</rp><rt>ǹ</rt><rp>）</rp>今<rp>（</rp><rt>jiēng</rt><rp>）</rp>日<rp>（</rp><rt>ràq</rt><rp>）</rp>
